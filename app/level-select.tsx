...
export default function LevelSelectScreen() {
  ...
  const handleSelectLevel = async (levelId: 1 | 2) => {
    ...
    router.push('/battle-arena' as any);
  };
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="flex-1">
        <View className="flex-1 justify-center items-center gap-6 px-6 py-8">
          ...
          <View className="gap-4 w-full max-w-sm">
            {[1, 2].map((levelId) => {
              ...
              return (
                <Pressable
                  key={levelId}
                  onPress={() => handleSelectLevel(levelId as 1 | 2)}
                  style={({ pressed }) => [
                    {
                  ...
                  <View className="gap-3">
                    ...
                    <View className="flex-row items-center gap-2">
                      ...
                      <Text className="text-xs text-muted flex-1">
                        {levelId === 1 ? '适合新手，怪物移动缓慢' : '挑战高手，怪物速度快'}
                      </Text>
                    </View>
          ...
          <Pressable
            ...
            className="mt-4"
          >
            <Text className="text-base text-primary font-semibold">← 返回</Text>
          </Pressable>
        </View>
      </ScrollView>
    </ScreenContainer>
